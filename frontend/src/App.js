  ...
  const handleImagemSelecionada = async (e) => {
    ...
    reader.onloadend = async () => {
      ...
      try {
        await axios.post(
          `${BACKEND}/send-image`,
          { student: alunoChat, imageBase64: base64, caption: "" },
          { headers: { Authorization: `Bearer ${token}` } },
        );
      } catch {
        ...
        <div className="modal-overlay" onClick={() => setModalAluno(false)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-field">
                <label>
                  Telefone (WhatsApp) <span className="obrigatorio">*</span>
                </label>
                <InputText
              ...
              <div className="modal-field">
                <label>
                  Formação <span className="opcional">(opcional)</span>
                </label>
                <InputText
                  value={novoAluno.curso}
                  onChange={(e) =>
                    setNovoAluno({ ...novoAluno, curso: e.target.value })
                  }
            ...
            <div className="modal-footer">
              ...
              />
              <Button
                label={salvandoAluno ? "Salvando..." : "Adicionar"}
                icon="pi pi-check"
      ...
      <header className="topbar">
        ...
        <div className="topbar-right">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="topbar-manual"
            title="Manual de Uso"
          >
            <i className="pi pi-book" /> Manual
          </a>
                    ...
                    <>
                      ...
                      <div className="whats-input-area">
                          ...
                          {mostrarEmoji && (
                            <div className="whats-emoji-picker">
                              {EMOJIS.map((emoji) => (
                                <button
                                  key={emoji}
                                  className="whats-emoji-btn"
                                  onClick={() => {
                                    setMsgWhats((v) => v + emoji);
                        ...
                        <button
                          className={
                            "whats-btn-icon " +
                            (gravandoAudio ? "whats-btn-gravando" : "")
                          }
                          title={
                            gravandoAudio
                              ? "Solte para enviar"
                        ...
                        <input
                          ...
                          disabled={gravandoAudio || enviandoImagem}
                        />
                        <button
